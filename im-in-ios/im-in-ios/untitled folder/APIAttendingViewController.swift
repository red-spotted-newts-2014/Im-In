...
protocol APIAttendingControllerProtocol {
    func didReceiveAPIResults(results: NSDictionary)
}

class APIAttendingController {
    
    var delegate: APIAttendingControllerProtocol?
    ...
    func loadAllEvents() {
        ...
        let urlPath = "http://10.0.2.26:3000/users/1/attending.json"
