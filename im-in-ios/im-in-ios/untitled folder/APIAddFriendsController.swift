...
protocol APIAddFriendsControllerProtocol {
    func didReceiveAPIResults(results: NSDictionary)
}

class APIAddFriendsController {
    
    var delegate: APIAddFriendsControllerProtocol?
    ...
    func loadAllEvents() {
        ...
        let urlPath = "http://10.0.2.26:3000/users/1/following.json"
